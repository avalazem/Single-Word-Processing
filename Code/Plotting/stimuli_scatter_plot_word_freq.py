...
stimuli_df = pd.read_csv(r'C:/Users/ali_a/Desktop/Single Word Processing Stage/Single Word Processing/Data/English Data/English_Stimuli.csv')

print(stimuli_df.head())
# Scatter Plot:
...
plt.title('Comparison of Length and Word Frequency Across 8 Conditions', y=1.06)
...
condition_wordlength_counts = stimuli_df.groupby(['Condition', 'Length']).size().reset_index(name='Count')
