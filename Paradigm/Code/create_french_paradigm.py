...
# File paths
visual_stimuli_path = r"C:\Users\ali_a\Desktop\Single_Word_Processing_Stage\Single_Word_Processing\Stimuli\Visual\French\French_Stimuli.csv"
audio_files_path = r"C:\Users\ali_a\Desktop\Single_Word_Processing_Stage\Single_Word_Processing\Stimuli\Auditory\French\Google_Cloud_French"
    ...
    if matching_files:
        ...
        for file in matching_files:
            if file.endswith(('_FEMALE_C.wav')):  # Female voice files
                female_audio = file
            elif file.endswith(('_MALE_G.wav')):  # Male voice files
                male_audio = file
...
output_path = r"C:\Users\ali_a\Desktop\Single_Word_Processing_Stage\Single_Word_Processing\Paradigm\Input_Data\fr_paradigm.csv"
